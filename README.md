...
<a href="https://github.com/DevRajah">
<img src="https://img.shields.io/badge/GitHub-DevRajah-181717?style=for-the-badge&logo=github"/>
</a>

<a href="https://www.linkedin.com/in/micheal-adekunle-b02b96291">
<img src="https://img.shields.io/badge/LinkedIn-Micheal_Adekunle-0A66C2?style=for-the-badge&logo=linkedin"/>
</a>
...
- 📦 Published on npm with over 2000 downloads
- 🌍 Used by developers through `npx`
- ⚙ Continually evolving with new backend capabilities

**Core Stack**

`Node.js` • `TypeScript` • `Commander.js` • `Express` • `MongoDB` • `Redis` • `BullMQ`
...
`Node.js` • `TypeScript` • `PostgreSQL` • `Redis` • `BullMQ` • `Prisma`
...
`Node.js` • `Express` • `TypeScript` • `PostgreSQL` • `Prisma` • `JWT` • `Swagger` • `Jest` • `OWASP ZAP` • `Apache JMeter`
...
<img src="https://img.shields.io/badge/BullMQ-EA580C?style=for-the-badge"/>
<img src="https://img.shields.io/badge/Redis-DC382D?style=for-the-badge&logo=redis"/>
<img src="https://img.shields.io/badge/Event--Driven-16A34A?style=for-the-badge"/>
<img src="https://img.shields.io/badge/Workers-2563EB?style=for-the-badge"/>
...
<img src="https://img.shields.io/badge/Helmet-16A34A?style=for-the-badge"/>
<img src="https://img.shields.io/badge/CORS-2563EB?style=for-the-badge"/>
...
<img src="https://img.shields.io/badge/Supertest-111827?style=for-the-badge"/>
...
<img src="https://img.shields.io/badge/Apache_JMeter-D22128?style=for-the-badge"/>
<img src="https://img.shields.io/badge/OWASP_ZAP-000000?style=for-the-badge"/>
...
- 📦 Published on npm
- 🚀 Used through `npx`
- 🔄 Continuously evolving with new templates and features
...
- ⚙️ Processed over **5,000 simulated reconciliation events**
- 📊 Zero request failures during load testing
...
- ✅ Automated integration testing with Jest & Supertest
- ✅ Security evaluation using OWASP ZAP
- ✅ API performance benchmarking using Apache JMeter
...
- 📦 Published a backend scaffolding CLI on npm
- ⚙️ Built multiple production-style backend systems
- 🧠 Designed distributed worker architectures using BullMQ and Redis
- 🔄 Implemented asynchronous processing pipelines
- 🔐 Built secure authentication and RBAC systems
- 🛡 Evaluated backend security using OWASP ZAP
- 🧪 Implemented automated API integration testing with Jest and Supertest
- 🚀 Benchmarked backend APIs using Apache JMeter
...
|---------|------|--------------|--------|
| Vercel AI SDK Ecosystem | AI Tooling | Engineering Contribution | ✅ Merged |
| iii | Infrastructure | Worker Investigation | ✅ Accepted Feedback |
| Twitter / The Algorithm | Recommendation Systems | Engineering Contribution | 🔄 Active |
| Node.js | Runtime | Coverage Investigation | 🔄 Active |
| Bruno | API Tooling | Bug Investigation | ✅ Contributed |
| js-good-first-issues-finder | Developer Tooling | Pull Request | ✅ Submitted |
...
# 💡 Engineering Topics I Enjoy Exploring
...
[![GitHub](https://img.shields.io/badge/GitHub-DevRajah-181717?style=for-the-badge&logo=github)](https://github.com/DevRajah)
